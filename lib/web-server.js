 ...
 * @param {Object=} options.autoCompile 启用自动编译功能，指定要启用的编译类型
 * @constructor
...
WebServer.prototype.init = function (app, options) {
    ...
    if (!proxyMiddleware) {
        ...
        // 初始化自动编译中间件
        initAutoCompileMiddleware(app, rootPath, options.autoCompile);
...
WebServer.prototype.getConnectionCount = function () {
    return this.io.sockets.clients().length;
};
 ...
 */
WebServer.prototype.sendCommandMessage = function (data, client) {
    var cmdName = 'command';
