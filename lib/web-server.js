        ...
        tasks.push({
            ...
            options: {
                ...
                updater: function (loaderScript) {
                    ...
                    var entryScripts = hmrOpt.entry || [];
                    if (!Array.isArray(entryScripts)) {
                        entryScripts = [entryScripts];
                    }
                    entryScripts.forEach(function (src, index) {
                        preLoadScripts.push('<script src="' + src + '"></script>');
                    });
                    return preLoadScripts.join('');
                }
            }
        });
